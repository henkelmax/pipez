...
public class CycleFilterModeMessage implements Message<CycleFilterModeMessage> {
    ...
    public static final CustomPacketPayload.Type<CycleFilterModeMessage> TYPE = new CustomPacketPayload.Type<>(Identifier.fromNamespaceAndPath(PipezMod.MODID, "cycle_filter_mode"));
