...
public class ModItems {
    ...
    private static final DeferredRegister.Items ITEM_REGISTER = DeferredRegister.createItems(PipezMod.MODID);
    ...
    private static final DeferredRegister<DataComponentType<?>> DATA_COMPONENT_TYPE_REGISTER = DeferredRegister.create(BuiltInRegistries.DATA_COMPONENT_TYPE, PipezMod.MODID);
