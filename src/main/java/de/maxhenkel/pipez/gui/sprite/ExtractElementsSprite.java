...
public class ExtractElementsSprite {
    ...
    public static SpriteRect FILTER_LIST_ENTRY = new SpriteRect(0, 96, 125, ROW_HEIGHT);
    public static SpriteRect FILTER_LIST_ENTRY_SELECTED = new SpriteRect(0, 118, 125, ROW_HEIGHT);

    public static SpriteRect FILTER_LIST_SCROLLER_ACTIVE = new SpriteRect(125, 96, 10, 17);
    public static SpriteRect FILTER_LIST_SCROLLER_INACTIVE = new SpriteRect(125, 96, 10, 17);
    ...
    public static SpriteRect FILTER_ENTRY_BUTTON_ADD = new SpriteRect(7, FILTER_MODE_BUTTON.y + FILTER_MODE_BUTTON.h + BUTTON_MARGIN, 20, 20);
    public static SpriteRect FILTER_ENTRY_BUTTON_EDIT = new SpriteRect(7, FILTER_ENTRY_BUTTON_ADD.y + FILTER_ENTRY_BUTTON_ADD.h + BUTTON_MARGIN, 20, 20);
    public static SpriteRect FILTER_ENTRY_BUTTON_DELETE = new SpriteRect(7, FILTER_ENTRY_BUTTON_EDIT.y + FILTER_ENTRY_BUTTON_EDIT.h + BUTTON_MARGIN, 20, 20);
